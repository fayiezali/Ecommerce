...
class SubCategoryMODEL(models.Model):
	...
	SubCat_image         = models.ImageField(upload_to="Sub_Catgories_File_Photo/" , db_index=True , blank=False  , null=False , verbose_name="Image Preview"  ,default='Default_Image.png')
...
class SubCategoryBranchMODEL(models.Model):
	...
	SubCatBra_image          = models.ImageField(upload_to="Sub_Catgories_Branch_File_Photo/" , db_index=True , blank=False  , null=False , verbose_name="Image Preview"  ,default='Default_Image.png')
