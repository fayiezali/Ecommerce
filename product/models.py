...
from category.models import SubCategoryBranchMODEL 
from .models import *
...
class ProductMODEL(models.Model):
    product_category      = models.ForeignKey(SubCategoryBranchMODEL , related_name='products', on_delete=models.CASCADE ,  verbose_name='Sub Category Branch')
    ...
    product_offer_price     = models.DecimalField(max_digits=10,decimal_places=2 , verbose_name='Offer Price')
